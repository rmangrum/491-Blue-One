...
Fireball.prototype.update = function () {
    ...
    if (collision || this.position.right > this.game.background.rightWall || this.position.left < this.game.background.leftWall || this.position.right > this.game.camera.x + this.game.ctx.width * 1.5 || this.position.left < this.game.camera.x - this.game.ctx.width * 0.5) {
...
Player.prototype.update = function() {
    ...
    if (this.game.cKey && this.activeHero === 0) {
        console.log(`Player position: (${this.game.player.position.left}, ${this.game.player.position.top})`);
...
AM.downloadAll(function () {
    ...
    var stageList = [new Stage(new Background(gameEngine, AM.getAsset("./img/levels/st1lv1.png"), 24, 2310, 24, 1030, 2336, 1056),
                        ...
                        [], [new Door(gameEngine, 2304, 72, 1, 0)], [], [new Position(25, 575, 25, 575, 1, 1), new Position (2260, 72, 2260, 72, 1, 1),
